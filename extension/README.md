...
├── src/
│   ├── config.ts          # Extension settings (backend URL, timeouts, etc.)
│   ├── contentScript.ts   # Runs in Gmail, detects paste events
│   └── background.ts      # Service worker, calls backend API
